          ...
          <div className="lg:col-span-2">
            <Card className="bg-dark-800 shadow-lg">
              <CardHeader className="px-6 py-4 bg-dark-800 border-b border-dark-900 flex justify-between items-center">
                <CardTitle className="text-lg font-medium text-white">Audit Report PDF</CardTitle>
                <div>
                  <Button variant="ghost" size="icon" onClick={handleDownload}>
                    <span className="material-icons text-gray-400 hover:text-white">file_download</span>
                  </Button>
                </div>
              </CardHeader>
                ...
                <div className="bg-dark-900 rounded-md h-96 flex items-center justify-center">
                  {pdfUrl ? (
                    ...
                    <div className="text-center">
                      <span className="material-icons text-4xl text-gray-500 mb-4">description</span>
                ...
                <div className="mt-4 flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-xs font-mono text-white">
                      {auditData.ipfsHash?.substring(0, 8)}...{auditData.ipfsHash?.substring(auditData.ipfsHash.length - 4)}
                    </span>
                  </div>
                  <div>
                    <Button 
                      ...
                      onClick={() => window.open(`https://ipfs.io/ipfs/${auditData.ipfsHash}`, '_blank')}
                    >
          ...
          <div>
            <Card className="bg-dark-800 shadow-lg mb-6">
              <CardHeader className="px-6 py-4 bg-dark-800 border-b border-dark-900">
                <CardTitle className="text-lg font-medium text-white">Audit Process Summary</CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                <ol className="space-y-4">
                  <li className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-400 mt-1">AI analysis of your code using Google Gemini</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-white font-medium">PDF Report Generation</p>
                      <p className="text-xs text-gray-400 mt-1">Comprehensive report with findings and recommendations</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-white font-medium">IPFS Storage</p>
                      <p className="text-xs text-gray-400 mt-1">Permanent decentralized storage of your audit</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-white font-medium">Cross-Chain Verification</p>
                      <p className="text-xs text-gray-400 mt-1">Wormhole bridging from Ethereum to Sui</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-white font-medium">NFT Certificate</p>
                      <p className="text-xs text-gray-400 mt-1">On-chain proof of your smart contract audit</p>
                    </div>
                  </li>
                </ol>
              </CardContent>
            ...
            <Card className="bg-dark-800 shadow-lg">
              ...
              <CardContent className="p-6 space-y-3">
                ...
                >
                  <span className="material-icons text-sm mr-2">collections</span>
                  View NFT in Wallet
                </Button>
